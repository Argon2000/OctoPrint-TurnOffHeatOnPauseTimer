...
description: Enables setting a timer for how long after the printer is paused that it should turn off hotend and/or heatbed.
authors:
- Per Åstrand
license: AGPLv3
...
http://plugins.octoprint.org/plugin/turn_off_heat_on_pause_timer/
